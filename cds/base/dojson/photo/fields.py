...
def image(self, key, value):
    """Image. Contains url to the concrete image file and information about the format"""
    return {
...
def reverse_owner(self, key, value):
    """Reverse - Information about the people having write permission over this record"""
    return {
        'a': value.get('contact'),
        'f': value.get('e-mail'),
        'x': value.get('date'),
